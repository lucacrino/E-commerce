...
--Note: according to the Accrual Accounting principles revenues are recognized when the good/service is earned (delivery_date is not null, hence the good has been delivered) and not when cash is paid (order_date). This standard will be adopted across the whole project.         
